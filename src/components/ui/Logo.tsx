  ...
  return (
    <div className="flex items-center cursor-pointer group" onClick={onClick}>
      {/* <div className="relative w-12 h-12 rounded-xl overflow-hidden flex items-center justify-center shrink-0 bg-white border border-brand/10 shadow-sm group-hover:scale-105 transition-transform">
         */}
      <div className="relative w-12 h-12 overflow-hidden flex items-center justify-center shrink-0">
      ...
      <div className="flex flex-col leading-none">
        <span className={`text-xl font-black tracking-tighter text-brand transition-colors`} style={{ textDecorationLine: 'none' }}>Brand Propel Studio</span>
